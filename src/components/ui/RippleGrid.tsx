...
const RippleGrid: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    const gridColorRgb = hexToRgb(DEFAULT_GRID_COLOR);
...
void main() {
    ...
    const render = (t: number) => {
      uniforms.iTime.value = t * 0.001 * speedRef.current;
  ...
  useEffect(() => {
    ...
    uniformsRef.current.gridColor.value = hexToRgb(DEFAULT_GRID_COLOR);
