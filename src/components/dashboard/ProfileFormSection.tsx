  ...
  return (
    <section id="profile" className="mb-16">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-black text-[#e5e5e5]">
          My profile
        </h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="bg-zinc-950 rounded-[1.5rem] border border-[#ffffff]/15 p-6 sm:p-8 shadow-sm">
          <h3 className="text-sm font-black text-[#ffffff] uppercase tracking-widest mb-6">
            Basic info
          </h3>
          <div className="space-y-5">
            <div>
              <label className="block text-xs font-bold text-[#ffffff]/80 uppercase tracking-wider mb-2">
                Name
              </label>
              <input
                value={form.name ?? ""}
                ...
                className="w-full px-4 py-3.5 bg-[#ffffff]/5 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-[#ffffff]/80 uppercase tracking-wider mb-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#ffffff]/10 border border-[#ffffff]/20 flex items-center justify-center text-[#ffffff] hover:bg-[#ffffff]/20 transition-colors disabled:opacity-50 disabled:pointer-events-none"
                  disabled={
                ...
                <input
                  ...
                  placeholder="0"
                  className="w-24 px-4 py-3.5 bg-[#ffffff]/5 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] text-center text-lg font-bold focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#ffffff]/10 border border-[#ffffff]/20 flex items-center justify-center text-[#ffffff] hover:bg-[#ffffff]/20 transition-colors"
                >
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-4 py-3.5 bg-[#ffffff]/5 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30 resize-none"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-[#ffffff]/80 uppercase tracking-wider mb-2">
            ...
            <div>
              ...
              <p className="text-xs text-[#e5e5e5]/60 mb-2">
              ...
              <div className="space-y-2">
                {(form.bulletPoints ?? []).map((point, index) => (
                  <div key={index} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-[#ffffff]/5 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] text-sm focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30"
                    />
                    <button
                      type="button"
                      onClick={() =>
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm font-bold text-[#ffffff] hover:text-[#e5e5e5]"
                >
        ...
        <div className="bg-zinc-950 rounded-[1.5rem] border border-[#ffffff]/15 p-6 sm:p-8 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6">
            <div className="w-28 h-28 rounded-2xl overflow-hidden bg-[#ffffff]/10 border-2 border-[#ffffff]/20 shrink-0">
              {form.image ? (
                <Image
                  src={form.image}
                  alt="Profile"
                ...
                <div className="w-full h-full flex items-center justify-center text-[#ffffff]/40">
        ...
        <div className="bg-zinc-950 rounded-[1.5rem] border border-[#ffffff]/15 p-6 sm:p-8 shadow-sm">
          <h3 className="text-sm font-black text-[#ffffff] uppercase tracking-widest mb-6 flex items-center gap-2">
        ...
        <div className="bg-zinc-950 rounded-[1.5rem] border border-[#ffffff]/15 p-6 sm:p-8 shadow-sm">
          ...
          <p className="text-xs text-[#e5e5e5]/60 mb-4">
          ...
          <div className="space-y-4">
            {(form.certificates ?? []).map((cert, index) => (
              <div
                key={index}
                className="p-4 rounded-xl border border-[#ffffff]/20 bg-[#ffffff]/5 space-y-3"
              >
                <div className="flex justify-between items-start gap-2">
                  <span className="text-xs font-bold text-[#ffffff]/80">
                    Certificate {index + 1}
                  </span>
                  <button
                    type="button"
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-zinc-950 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30"
                />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-zinc-950 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] text-sm focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30"
                  />
                  <input
                    value={cert.year ?? ""}
                    onChange={(e) =>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg border border-[#ffffff]/20 text-[#ffffff] text-xs font-bold hover:bg-[#ffffff]/10 transition-colors"
                  >
                  ...
                  <input
                    ...
                    className="flex-1 min-w-[180px] px-4 py-2.5 bg-zinc-950 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] text-sm focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30"
                  />
                </div>
                {cert.image && (
                  <div className="relative w-20 h-20 rounded-lg overflow-hidden bg-[#ffffff]/10">
                    <Image
                      src={cert.image}
                      alt={cert.name}
                      fill
            ...
            <button
              ...
              className="flex items-center gap-2 w-full py-3 rounded-xl border-2 border-dashed border-[#ffffff]/30 text-[#ffffff] font-bold text-sm hover:bg-[#ffffff]/5 transition-colors"
            >
              <Plus className="w-5 h-5" />
              Add certificate
            </button>
          ...
          <div className="space-y-4">
            {SOCIAL_FIELDS.map(({ key, icon, placeholder }) => (
              <div key={key} className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#ffffff]/10 flex items-center justify-center text-[#ffffff] shrink-0">
                  {icon}
                </div>
                <input
                  ...
                  className="flex-1 px-4 py-3.5 bg-[#ffffff]/5 border border-[#ffffff]/20 rounded-xl text-[#e5e5e5] focus:outline-none focus:ring-2 focus:ring-[#ffffff]/30"
                />
              </div>
            ))}
          </div>
