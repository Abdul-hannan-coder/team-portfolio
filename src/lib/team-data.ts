...
export const seniorDevelopers: TeamMember[] = [
  {
    ...
    certificates: [
      ...
      },
      {
        ...
        issuer: "UET Lahore",
        image:
          "/uzair-detail/Artificial-Intelligence-and-Machine-Learning-(UET).png",
      ...
      },
      {
        ...
        image:
          "/uzair-detail/Career-Essentials-in-Generative-Al-(Microsoft and Linkedin).png",
      ...
      },
      {
        ...
        image:
          "/uzair-detail/Introduction-to-FastAPI-Framework(Duke-University).png",
...
export const testimonialTeam: TeamMember[] = [
  ...
  },
  {
    ...
    description:
      "MERN stack developer creating responsive and immersive web experiences",
    fullDescription:
      "Abdul Hannan specializes in React/Next + FastAPI/Node/Express with expertise in PostgreSQL, MongoDB, Docker & Cloud technologies. His focus on modern web technologies and collaborative approach results in robust and scalable applications that are both beautiful and highly performant.",
...
Maryam is a Certified Cloud Applied Generative AI Engineer (PIAIC, 2024), with advanced proficiency in Next.js, TypeScript, Tailwind CSS, Python, and FastAPI. She specializes in developing responsive, accessible, and high-performance web solutions—seamlessly integrating AI-driven features to deliver real-world value.`,
  ...
  },
  {
    ...
    description:
      "Building scalable backend infrastructure with Python and FastAPI",
...
Let's connect to create practical, future-ready AI software together.`,
  ...
  },
  {
    ...
    role: "Backend Software Engineer",
    description:
      "Professional AI Engineer specializing in Agentic systems, Python programming, and practical automation.",
